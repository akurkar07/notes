...
Source: [18 - Risk Management.pdf](<18 - Risk Management.pdf>)
...
```mermaid
flowchart LR
    Identify[Identify] --> Analyse[Analyse probability and impact]
    Analyse --> Prioritise[Prioritise]
    Prioritise --> Respond[Choose response]
    Respond --> Monitor[Monitor and revise]
```
